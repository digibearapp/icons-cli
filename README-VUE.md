# Digibear Icons for Vue

This guide will help you integrate Digibear Icons into your Vue application.
...
Then, scaffold the Vue components using the CLI:
...
dgbear scaffold -f vue -v 1.0.0 -o ./src/components/digibear-icons
```

# Digibear Icons for Svelte

This guide will help you integrate Digibear Icons into your Svelte application.
...
Then, scaffold the Svelte components using the CLI:
...
dgbear scaffold -f svelte -v 1.0.0 -o ./src/lib/digibear-icons
```

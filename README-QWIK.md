...
Then, scaffold the Qwik components using the CLI:

```bash
# Install the CLI globally
npm install -g @digibearapp/icons-cli

# Scaffold Qwik components
dgbear scaffold -f qwik -v 1.0.0 -o ./src/components/digibear-icons
```
...
export const IconGroupExample = component$(() => {
  return (
...
export const NestedGroupsExample = component$(() => {
  return (
...
export const ThemedIconsExample = component$(() => {
...
## Using with Qwik City

When using Digibear Icons with Qwik City, you can set up the icon scope at the layout level:

```tsx
import { component$, Slot } from "@builder.io/qwik";
import { DgbIconScope } from "@/components/digibear-icons";
